...
public class Main {
	public static void main(String[] args) {
		...
		String rutaRecetas = "C:\\Users\\Cosme Fulanito\\eclipse-workspace\\Ingredientes_prueba\\src\\utils\\recetas.xml";
		String rutaInventarioInicial = "C:\\Users\\Cosme Fulanito\\eclipse-workspace\\Ingredientes_prueba\\src\\utils\\inventarioInicial.xml";
		...
		// Obtengo la receta de "Hamburguesa Simple"
		Receta recetaHamburguesa = recetario.getReceta("Hamburguesa Simple");
		if (recetaHamburguesa != null) {
			System.out.println("Ingredientes directos para Hamburguesa Simple:");
			recetaHamburguesa.mostrarIngredientes();
		} else {
		...
		System.out.println("Ingredientes básicos necesarios para fabricar desde cero:");
		for (Map.Entry<String, Integer> entry : basicos.entrySet()) {
			System.out.println("- " + entry.getValue() + " x " + entry.getKey());
		}
		//probar si resta por crear un intermedio
		Basico item = (Basico)usuario.buscarItem("Harina");
		
		usuario.crearIntermedio("Harina");

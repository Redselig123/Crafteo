 ...
 * public abstract boolean puedeConstruirse(Almacen almacen); // verifica si hay
 * ingredientes public abstract void construir(Almacen almacen); // descuenta
 * del inventario y crea la hamburguesa
 */